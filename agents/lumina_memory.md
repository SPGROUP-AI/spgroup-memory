...
- btoa(unescape(encodeURIComponent())) 방식 사용 금지 (한글 깨짐)

## 필수 보존 규칙
홈페이지 수정 시 아래 3개 링크 반드시 유지:
...
태그 없으면 AutoReply 작동 안됨. 업데이트 후 spgpinc.com 버튼 href 반드시 확인.

## 세션 노트
2026.04.21: INQUIRY 태그 재복구 완료 (업데이트 시 2회 유실됨)
